...
Future<void> checkAPI() async {
  ...
  //print(activeMap);
   ...
   var showProductMap=valueMap['options']['productData'] as Map<String,dynamic>;
...
//print(activeMap['Necklaces'].items );
   ...
   String csv = codes.toString().replaceAll("[", "").replaceAll("]", "").replaceAll(", ", ",");
     
   setState(() {
     baseUrl = "https://cdn.styledotme.com/general/mirrar.html?brand_id=" + uuid + csv + "&sku=" + codes.elementAt(1).replaceAll("=,", "=").replaceAll(",&", "&");
   print(baseUrl);
   load=true;
   });
  }
